...
//             'items.*.barang_tersedia.nama_barang'     => 'nullable|string',
//             'items.*.barang_tersedia.jumlah'          => 'nullable|integer|min:0',
//             'items.*.barang_tersedia.tahun_perolehan' => 'nullable|integer',
//             'items.*.barang_tersedia.kondisi'         => 'nullable|string',
//         ]);
...
//                 'no_pengajuan'       => 'PGD-' . now()->format('YmdHis'),
//             ]);
...
//                 // =========================
//                 // Simpan barang tersedia (jika dicentang)
//                 // =========================
//                 if (
//                     isset($item['ada_barang_tersedia']) &&
//                     $item['ada_barang_tersedia'] == 1 &&
//                     isset($item['barang_tersedia'])
//                 ) {
...
//                         'nama_barang'       => $bt['nama_barang'] ?? null,
//                         'jumlah'            => $bt['jumlah'] ?? 0,
//                         'tahun_perolehan'   => $bt['tahun_perolehan'] ?? null,
//                         'kondisi'           => $bt['kondisi'] ?? null,
//                         'keterangan'        => null,
//                     ]);
//                 }
//             }
...
//                 ->with('success', 'Pengajuan pengadaan berhasil disimpan.');
...
//             'manfaat'            => 'required|string',
//             'dampak'             => 'required|string',
//             'tahun_anggaran'     => 'nullable|integer|min:2000',
...
//                 // Field opsional
//                 'kondisi_barang_lama' => null,
//                 'ket_barang_lama'     => null,
//             ]);
...
//                     'jumlah'       => $item['jumlah'],
//                     'harga_satuan' => $item['harga_satuan'],
//                     'harga'        => $totalItem, // <- field 'harga' untuk total
//                     'jumlah_disetujui' => $item['jumlah'], // default sama dengan jumlah
//                 ]);
...
//             return redirect()
//                 ->route('pemohon.pengadaan')
//                 ->with('success', 'Pengajuan pengadaan berhasil disimpan. Nomor: ' . $noPengajuan);
