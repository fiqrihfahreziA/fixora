...
//         'permintaan_count' => Pengajuan::whereNotIn('status', ['diajukan', 'draft', 'revisi', 'disetujui_koordinator'])
//             ->where(function($q) {
//                 $q->where('dasar_usulan', 'LIKE', '%permintaan%')
//                   ->orWhere('dasar_usulan', 'LIKE', '%pengadaan%')
//                   ->orWhere('dasar_usulan', 'LIKE', '%beli%')
...
//         'perbaikan_count' => Pengajuan::whereNotIn('status', ['diajukan', 'draft', 'revisi', 'disetujui_koordinator'])
//             ->where(function($q) {
//                 $q->where('dasar_usulan', 'LIKE', '%perbaikan%')
//                   ->orWhere('dasar_usulan', 'LIKE', '%service%')
//                   ->orWhere('dasar_usulan', 'LIKE', '%repair%');
