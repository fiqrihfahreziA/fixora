...
<head>
    ...
    <title>{{ $title ?? 'Atasan' }} | Aplikasi Permintaan & Perbaikan Barang</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                data-bs-target="#navbarAtasan">
            <span class="navbar-toggler-icon"></span>
        </button>

        <div class="collapse navbar-collapse" id="navbarAtasan">
            ...
            <ul class="navbar-nav ms-4 me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-1
                        {{ request()->is('atasan/permintaan*') ? 'active fw-semibold' : '' }}"
                       href="{{ route('atasan.permintaan') }}">
