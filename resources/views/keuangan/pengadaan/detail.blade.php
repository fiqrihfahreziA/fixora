...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                ...
                <small class="text-success ms-3">
                    ...
                    Disetujui Kabid: {{ date('d M Y H:i', strtotime($pengajuan->disetujui_kabid_at)) }}
                </small>
                @endif
            </div>
            <div>
        ...
        <div class="mt-3 p-3 bg-light rounded">
            <small class="text-muted fw-semibold">Catatan Kabid:</small>
        ...
        <div class="card border-0 shadow-sm bg-light mb-4">
            <div class="card-body">
                ...
                <ul class="small text-muted mb-0 ps-3">
                    <li class="mb-1">✅ <strong>Disetujui</strong> = Pengajuan disetujui keuangan</li>
                    <li class="mb-1">❌ <strong>Ditolak</strong> = Pengajuan ditolak</li>
                    <li>📝 <strong>Revisi</strong> = Kembali ke pemohon untuk revisi</li>
                </ul>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-transparent">
                <h6 class="fw-bold mb-0">
                    <i class="bi bi-person-check me-2 text-primary"></i>Verifikasi Keuangan
                </h6>
            </div>
            <div class="card-body">
                <div class="mb-3">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status_verifikasi" class="form-select" id="statusSelect" onchange="toggleRespon()" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="keteranganText" name="catatan_verifikasi" class="form-control" rows="3" 
...
function toggleRespon() {
    ...
    if (status === 'disetujui') {
        ...
        keteranganText.placeholder = 'Tuliskan catatan verifikasi...';
