                        ...
                        @foreach ($permintaanRequests as $req)
                            @if ($req->request_type === 'permintaan')
                                <tr>
                                    ...
                                    <td class="text-center">{{ Str::limit(optional($req->detailBarang)->alasan, 20, '...') }}</td>
                                    <td class="text-center">
                                        {{ $req->detailBarang?->created_at ? $req->detailBarang->created_at->format('Y-m-d') : 'Tidak ada' }}
                                    </td>
                                    <td class="text-center">
                                        @php
                                    ...
                                    <td class="text-center">
                                        @if ($req->status === 'approved')
                                            <a class="btn btn-sm btn-secondary btn-disabled">
                                        ...
                                        @else
                                            <a href="{{ route('penerima.permintaan.edit', $req->id) }}"
                                            class="btn btn-sm btn-success"
                                            target="_blank">
                                                <i class="bi bi-pencil"></i> Accept
                                            </a>

                                            {{-- <form action="{{ route('penerima.permintaan.destroyy', $req->id) }}"
                                                method="POST"
                                                class="d-inline"
                                        ...
                                        <a href="{{ route('penerima.permintaan.view', $req->id) }}"
                                        target="_blank"
        ...
        <div class="tab-pane fade" id="perbaikan" role="tabpanel" aria-labelledby="perbaikan-tab">
            <div class="table-responsive">
                            ...
                            @if ($req->request_type === 'perbaikan')
                                <tr>
                                    ...
                                    {{-- <td class="text-center">
                                            ...
                                            <a href="{{ route('penerima.permintaan.edit', $req->id) }}" class="btn btn-sm btn-success" target="_blank">
                                                <i class="bi bi-pencil"></i>Verif
                                            </a>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <small>
                        Menampilkan {{ $perbaikanRequests->firstItem() }}
                        - {{ $perbaikanRequests->lastItem() }}
                        dari {{ $perbaikanRequests->total() }} data
                    </small>
