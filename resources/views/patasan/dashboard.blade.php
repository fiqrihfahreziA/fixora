@extends('layouts.main.atasan')

@section('content')
<div class="row g-4">
    <!-- Card Kiri - Pengadaan -->
    <div class="col-md-6">
        <a href="{{ route('atasan.pengadaan') }}" class="text-decoration-none d-block">
    ...
    <div class="col-md-6">
        <a href="{{ route('atasan.permintaan') }}" class="text-decoration-none d-block">
